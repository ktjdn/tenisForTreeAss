...
; ASCII / ATTR CODES TO DRAW BALL 
;!Andreu!
    
	
	ASCII_BALL     EQU 02Ah		;pilota char
	ATTR_BALL      EQU 00Eh		;color fons char
      ATTR_BALL_N    EQU 000h       ;negre caselles vuides

; ASCII / ATTR CODES TO DRAW THE FIELD
;!Andreu!
    ASCII_FIELD    EQU 020h
    ATTR_FIELD     EQU 022h		;green
	
	ASCII_NET    EQU 020h		;xarxa
      ATTR_NET     EQU 0FFh

    ASCII_NUMBER_ZERO EQU 030h		; color blanc ????????
...
; ASCII
    ASCII_YES_UPPERCASE      EQU 059h				;mayusculas afecta
    ASCII_YES_LOWERCASE      EQU 079h				;minusculas afecta
...
; FIELD DIMENSIONS
	...
	FIELD_R3 EQU SCREEN_MAX_ROWS*2/3		;per dibuixar net
    FIELD_C1 EQU 1
    FIELD_C2 EQU SCREEN_MAX_COLS-2
	FIELD_C3 EQU SCREEN_MAX_COLS/2		;per dibuixar net
...
;_______________________________PRINT FIELD_____________________________
